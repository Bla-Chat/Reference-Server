<?PHP
	...
	function postData($user, $obj) {
		...
		if((endsWith($target_path, ".png") || endsWith($target_path, ".jpg")
		  ...
		  || endsWith($target_path, ".cs") || endsWith($target_path, ".cshtml")
		  || endsWith($target_path, ".csproj") || endsWith($target_path, ".sln")
		  || endsWith($target_path, ".config") || endsWith($target_path, ".ini")
		  || endsWith($target_path, ".xaml") || endsWith($target_path, ".yaml")
		  || endsWith($target_path, ".asax") || endsWith($target_path, ".aspx")
